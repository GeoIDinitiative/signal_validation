...
- 376 per-station 'significant' windows (≈ the 1% chance rate of the 99th-pct floor)
- cross-station synchrony: smallest p = 0.087 → **no significant coincident signal**

## Sensitivity (experiment, SNR₉₀)
- SWCC components: 1.03
- Net X: 0.47
- Net Y: 0.47
- SUBSPACE: 1.35
- ENVELOPE: 2.95
